        ...
        public void BattleUI() {
            if (Globals.IN_BATTLE && Globals.STATS_CHANGED) {
                ...
                for (int i = 0; i < Globals.MONSTER_SIZE; i++) {
                    ...
                    monsterDisplay[i, 2].Text = " " + Globals.MONSTER_TABLE[i].Read("ATK") + "/" + Globals.MONSTER_TABLE[i].Read("MAT");
                    monsterDisplay[i, 3].Text = " " + Globals.MONSTER_TABLE[i].Read("DEF") + "/" + Globals.MONSTER_TABLE[i].Read("MDEF");
                ...
                for (int i = 0; i < 3; i++) {
                    if (Globals.PARTY_SLOT[i] < 9) {
                        ...
                        characterDisplay[i, 2].Text = " " + Globals.CHARACTER_TABLE[i].Read("ATK") + "\r\n\r\n " + Globals.CHARACTER_TABLE[i].Read("MAT");
                        characterDisplay[i, 3].Text = " " + Globals.CHARACTER_TABLE[i].Read("DEF") + "\r\n\r\n " + Globals.CHARACTER_TABLE[i].Read("MDEF");
                        ...
                        characterDisplay[i, 5].Text = " " + Globals.CHARACTER_TABLE[i].Read("DATK") + "\r\n\r\n " + Globals.CHARACTER_TABLE[i].Read("DMAT");
                        characterDisplay[i, 6].Text = " " + Globals.CHARACTER_TABLE[i].Read("DDEF") + "\r\n\r\n " + Globals.CHARACTER_TABLE[i].Read("DMDEF");
